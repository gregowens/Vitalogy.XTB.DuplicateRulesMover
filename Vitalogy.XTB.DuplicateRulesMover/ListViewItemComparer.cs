...
namespace Vitalogy.XTB.DuplicateRulesMover
{
    ...
    internal class ListViewItemComparer : IComparer
    {
        ...
        {
            return _innerOrder == SortOrder.Ascending
                ? string.CompareOrdinal(x.SubItems[_col].Text, y.SubItems[_col].Text)
                : string.CompareOrdinal(y.SubItems[_col].Text, x.SubItems[_col].Text);
        }
